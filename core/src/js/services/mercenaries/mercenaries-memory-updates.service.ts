...
} from '../mainwindow/store/events/mercenaries/mercenaries-collection-information-from-memory-event';
import {
    MercenariesMapInformationFromMemoryEvent
} from '../mainwindow/store/events/mercenaries/mercenaries-map-information-from-memory-event';
