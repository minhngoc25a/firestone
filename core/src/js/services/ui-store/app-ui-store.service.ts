...
export class AppUiStoreService {
    ...
    private duelsHeroStats: BehaviorSubject<readonly DuelsHeroPlayerStat[]> = new BehaviorSubject<readonly DuelsHeroPlayerStat[]>(null);
    private duelsTopDecks: BehaviorSubject<readonly DuelsGroupedDecks[]> = new BehaviorSubject<readonly DuelsGroupedDecks[]>(null);
