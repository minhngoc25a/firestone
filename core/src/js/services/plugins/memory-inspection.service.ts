...
import {
    GetDuelsHeroPowerOptionsOperation
} from '@services/plugins/mind-vision/operations/get-duels-hero-power-options-operation';
import {
    GetDuelsSignatureTreasureOptionsOperation
} from '@services/plugins/mind-vision/operations/get-duels-signature-treasure-options-operation';
...
import {
    GetBattlegroundsOwnedHeroSkinDbfIdsOperation
} from './mind-vision/operations/get-bgs-hero-skin-dbf-ids-operation';
...
import {
    GetInGameAchievementsProgressInfoOperation
} from './mind-vision/operations/get-in-game-achievements-progress-info-operation';
...
import {
    GetMercenariesCollectionInfoOperation
} from './mind-vision/operations/get-mercenaries-collection-info-operation';
