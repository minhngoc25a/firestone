...
} from '@components/battlegrounds/minions-tiers/battlegrounds-minions-tiers-view.component';
...
} from '../../components/battlegrounds/battles/bgs-hero-portrait-simulator.component';
...
} from '../../components/battlegrounds/hero-selection/bgs-hero-selection-tooltip.component';
...
} from '../../components/battlegrounds/in-game/bgs-opponent-overview-big.component';
...
} from '../../components/battlegrounds/overlay/bgs-leaderboard-empty-card.component';
import {
    BgsOverlayHeroOverviewComponent
} from '../../components/battlegrounds/overlay/bgs-overlay-hero-overview.component';
...
} from '../../components/battlegrounds/post-match/bgs-chart-warband-composition.component';
import {
    BgsChartWarbandStatsComponent
} from '../../components/battlegrounds/post-match/bgs-chart-warband-stats.component';
import {
    BgsPostMatchStatsRecapComponent
} from '../../components/battlegrounds/post-match/bgs-post-match-stats-recap.component';
import {
    BgsPostMatchStatsTabsComponent
} from '../../components/battlegrounds/post-match/bgs-post-match-stats-tabs.component';
...
} from '../../components/decktracker/overlay/twitch/leaderboard-empty-card.component';
import {
