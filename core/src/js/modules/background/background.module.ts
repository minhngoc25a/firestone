...
} from '@components/duels/desktop/deckbuilder/duels-deckbuilder-breadcrumbs.component';
...
} from '@components/duels/desktop/deckbuilder/duels-deckbuilder-hero-power.component';
...
} from '@components/duels/desktop/deckbuilder/duels-deckbuilder-signature-treasure.component';
...
} from '@components/duels/desktop/filters/duels-locked-requirements-filter-dropdown.component';
...
} from '@components/overlays/counters/opponent-abyssal-curse-widget-wrapper.component';
import {
    PlayerAbyssalCurseWidgetWrapperComponent
} from '@components/overlays/counters/player-abyssal-curse-widget-wrapper.component';
import {
    PlayerBgsMajordomoWidgetWrapperComponent
} from '@components/overlays/counters/player-bgs-majordomo-widget-wrapper.component';
import {
    PlayerBgsSouthseaWidgetWrapperComponent
} from '@components/overlays/counters/player-bgs-southsea-widget-wrapper.component';
import {
    PlayerCoralKeeperWidgetWrapperComponent
} from '@components/overlays/counters/player-coral-keeper-widget-wrapper.component';
import {
    PlayerGreySageParrotWidgetWrapperComponent
} from '@components/overlays/counters/player-grey-sage-parrot-widget-wrapper.component';
...
} from '@components/overlays/duels-decktracker-ooc-widget-wrapper.component';
import {
    DuelsOocDeckSelectWidgetWrapperComponent
} from '@components/overlays/duels-ooc-deck-select-widget-wrapper.component';
import {
    DuelsOutOfCombatHeroPowerSelectionWidgetWrapperComponent
} from '@components/overlays/duels-ooc-hero-power-selection-widget-wrapper.component';
import {
    DuelsOutOfCombatHeroSelectionWidgetWrapperComponent
} from '@components/overlays/duels-ooc-hero-selection-widget-wrapper.component';
import {
    DuelsOutOfCombatSignatureTreasureSelectionWidgetWrapperComponent
} from '@components/overlays/duels-ooc-signature-treasure-widget-wrapper.component';
import {
    DuelsOutOfCombatTreasureSelectionWidgetWrapperComponent
} from '@components/overlays/duels-ooc-treasure-selection-widget-wrapper.component';
...
} from '@components/overlays/duels-ooc/duels-ooc-hero-power-selection.component';
import {
    DuelsOutOfCombatHeroSelectionComponent
} from '@components/overlays/duels-ooc/duels-ooc-hero-selection.component';
import {
    DuelsOutOfCombatSignatureTreasureSelectionComponent
} from '@components/overlays/duels-ooc/duels-ooc-signature-treasure-selection.component';
import {
    DuelsOutOfCombatTreasureSelectionComponent
} from '@components/overlays/duels-ooc/duels-ooc-treasure-selection.component';
import {
    DuelsSignatureTreasureInfoComponent
} from '@components/overlays/duels-ooc/duels-signature-treasure-info.component';
...
} from '@components/overlays/session/current-session-bgs-board-tooltip.component';
...
} from '@components/settings/battlegrounds/settings-battlegrounds-overlay.component';
import {
    SettingsBattlegroundsSessionComponent
} from '@components/settings/battlegrounds/settings-battlegrounds-session.component';
...
} from '../../components/achievements/filters/achievements-completed-filter-dropdown.component';
...
} from '../../components/arena/desktop/filters/arena-class-filter-dropdown.component';
import {
    ArenaTimeFilterDropdownComponent
} from '../../components/arena/desktop/filters/arena-time-filter-dropdown.component';
...
} from '../../components/battlegrounds/battles/bgs-simulator-hero-power-selection.component';
import {
    BgsSimulatorHeroSelectionComponent
} from '../../components/battlegrounds/battles/bgs-simulator-hero-selection.component';
import {
    BgsSimulatorMinionSelectionComponent
} from '../../components/battlegrounds/battles/bgs-simulator-minion-selection.component';
import {
    BattlegroundsSimulatorMinionTierFilterDropdownComponent
} from '../../components/battlegrounds/battles/bgs-simulator-minion-tier-filter-dropdown.component';
import {
    BattlegroundsSimulatorMinionTribeFilterDropdownComponent
} from '../../components/battlegrounds/battles/bgs-simulator-minion-tribe-filter-dropdown.component';
...
} from '../../components/battlegrounds/desktop/battlegrounds-category-details.component';
...
} from '../../components/battlegrounds/desktop/categories/battlegrounds-perfect-games.component';
import {
    BattlegroundsPersonalStatsHeroDetailsComponent
} from '../../components/battlegrounds/desktop/categories/battlegrounds-personal-stats-hero-details.component';
import {
    BattlegroundsPersonalStatsHeroesComponent
} from '../../components/battlegrounds/desktop/categories/battlegrounds-personal-stats-heroes.component';
import {
    BattlegroundsPersonalStatsRatingComponent
} from '../../components/battlegrounds/desktop/categories/battlegrounds-personal-stats-rating.component';
import {
    BattlegroundsPersonalStatsStatsComponent
} from '../../components/battlegrounds/desktop/categories/battlegrounds-personal-stats-stats.component';
import {
    BattlegroundsSimulatorComponent
} from '../../components/battlegrounds/desktop/categories/battlegrounds-simulator.component';
import {
    BattlegroundsStatsHeroVignetteComponent
} from '../../components/battlegrounds/desktop/categories/battlegrounds-stats-hero-vignette.component';
import {
...
} from '../../components/battlegrounds/desktop/categories/hero-details/bgs-last-warbands.component';
import {
    BgsMmrEvolutionForHeroComponent
} from '../../components/battlegrounds/desktop/categories/hero-details/bgs-mmr-evolution-for-hero.component';
import {
    BgsWarbandStatsForHeroComponent
} from '../../components/battlegrounds/desktop/categories/hero-details/bgs-warband-stats-for-hero.component';
import {
    BgsWinrateStatsForHeroComponent
} from '../../components/battlegrounds/desktop/categories/hero-details/bgs-winrate-stats-for-hero.component';
import {
    BattlegroundsHeroFilterDropdownComponent
} from '../../components/battlegrounds/desktop/filters/battlegrounds-hero-filter-dropdown.component';
import {
    BattlegroundsHeroSortDropdownComponent
} from '../../components/battlegrounds/desktop/filters/battlegrounds-hero-sort-dropdown.component';
import {
    BattlegroundsRankFilterDropdownComponent
} from '../../components/battlegrounds/desktop/filters/battlegrounds-rank-filter-dropdown.component';
import {
    BattlegroundsRankGroupDropdownComponent
} from '../../components/battlegrounds/desktop/filters/battlegrounds-rank-group-dropdown.component';
import {
    BattlegroundsTimeFilterDropdownComponent
} from '../../components/battlegrounds/desktop/filters/battlegrounds-time-filter-dropdown.component';
import {
    BattlegroundsTribesFilterDropdownComponent
} from '../../components/battlegrounds/desktop/filters/battlegrounds-tribes-filter-dropdown.component';
import {
    BattlegroundsFiltersComponent
} from '../../components/battlegrounds/desktop/filters/_battlegrounds-filters.component';
import {
    BattlegroundsHeroRecordsBrokenComponent
} from '../../components/battlegrounds/desktop/secondary/battlegrounds-hero-records-broken.component';
import {
    BattlegroundsHeroesRecordsBrokenComponent
} from '../../components/battlegrounds/desktop/secondary/battlegrounds-heroes-records-broken.component';
import {
    BattlegroundsReplaysRecapComponent
} from '../../components/battlegrounds/desktop/secondary/battlegrounds-replays-recap.component';
import {
    BattlegroundsTierListComponent
} from '../../components/battlegrounds/desktop/secondary/battlegrounds-tier-list.component';
...
} from '../../components/battlegrounds/hero-selection/bgs-hero-selection-overview.component';
...
} from '../../components/battlegrounds/in-game/bgs-next-opponent-overview.component';
...
} from '../../components/battlegrounds/minions-tiers/battlegrounds-minions-tiers.component';
import {
    BattlegroundsOverlayButtonComponent
} from '../../components/battlegrounds/overlay/battlegrounds-overlay-button.component';
import {
    BgsHeroSelectionOverlayComponent
} from '../../components/battlegrounds/overlay/bgs-hero-selection-overlay.component';
...
} from '../../components/battlegrounds/simulation-overlay/bgs-simulation-overlay.component';
...
} from '../../components/collection/filters/collection-hero-portrait-categories-filter-dropdown.component';
import {
    CollectionHeroPortraitOwnedFilterDropdownComponent
} from '../../components/collection/filters/collection-hero-portrait-owned-filter-dropdown.component';
...
} from '../../components/decktracker/main/decktracker-personal-stats-ranking.component';
...
} from '../../components/decktracker/main/decktracker-stats-for-replays.component';
import {
    DecktrackerDeckSortDropdownComponent
} from '../../components/decktracker/main/filters/decktracker-deck-sort-dropdown.component';
import {
    DecktrackerFormatFilterDropdownComponent
} from '../../components/decktracker/main/filters/decktracker-format-filter-dropdown.component';
import {
    DecktrackerRankCategoryDropdownComponent
} from '../../components/decktracker/main/filters/decktracker-rank-category-dropdown.component';
import {
    DecktrackerRankFilterDropdownComponent
} from '../../components/decktracker/main/filters/decktracker-rank-filter-dropdown.component';
import {
    DecktrackerRankGroupDropdownComponent
} from '../../components/decktracker/main/filters/decktracker-rank-group-dropdown.component';
import {
    DecktrackerTimeFilterDropdownComponent
} from '../../components/decktracker/main/filters/decktracker-time-filter-dropdown.component';
...
} from '../../components/decktracker/main/menu-selection-decktracker.component';
import {
    DeckTrackerOverlayOpponentComponent
} from '../../components/decktracker/overlay/decktracker-overlay-opponent.component';
import {
    DeckTrackerOverlayPlayerComponent
} from '../../components/decktracker/overlay/decktracker-overlay-player.component';
import {
    TwitchBgsHeroOverviewComponent
} from '../../components/decktracker/overlay/twitch/twitch-bgs-hero-overview.component';
...
} from '../../components/duels/desktop/duels-personal-deck-vignette.component';
...
} from '../../components/duels/desktop/filters/duels-dust-filter-dropdown.component';
import {
    DuelsGameModeFilterDropdownComponent
} from '../../components/duels/desktop/filters/duels-game-mode-filter-dropdown.component';
import {
    DuelsHeroFilterDropdownComponent
} from '../../components/duels/desktop/filters/duels-hero-filter-dropdown.component';
import {
    DuelsHeroPowerFilterDropdownComponent
} from '../../components/duels/desktop/filters/duels-hero-power-filter-dropdown.component';
import {
    DuelsHeroSortDropdownComponent
} from '../../components/duels/desktop/filters/duels-hero-sort-dropdown.component';
import {
    DuelsLeaderboardGameModeFilterDropdownComponent
} from '../../components/duels/desktop/filters/duels-leaderboard-game-mode-filter-dropdown.component';
import {
    DuelsMmrFilterDropdownComponent
} from '../../components/duels/desktop/filters/duels-mmr-filter-dropdown.component';
import {
    DuelsSignatureTreasureFilterDropdownComponent
} from '../../components/duels/desktop/filters/duels-signature-treasure-filter-dropdown.component';
import {
    DuelsStatTypeFilterDropdownComponent
} from '../../components/duels/desktop/filters/duels-stat-type-filter-dropdown.component';
import {
    DuelsTimeFilterDropdownComponent
} from '../../components/duels/desktop/filters/duels-time-filter-dropdown.component';
import {
    DuelsTreasurePassiveTypeFilterDropdownComponent
} from '../../components/duels/desktop/filters/duels-treasure-passive-type-filter-dropdown.component';
import {
    DuelsTreasuresSortDropdownComponent
} from '../../components/duels/desktop/filters/duels-treasures-sort-dropdown.component';
...
} from '../../components/duels/desktop/secondary/duels-replays-recap-for-run.component';
...
} from '../../components/duels/desktop/secondary/duels-treasure-tier-list.component';
...
} from '../../components/mercenaries/desktop/filters/mercenaries-fully-upgraded-filter-dropdown.component';
import {
    MercenariesHeroLevelFilterDropdownComponent
} from '../../components/mercenaries/desktop/filters/mercenaries-level-filter-dropdown.component';
import {
    MercenariesModeFilterDropdownComponent
} from '../../components/mercenaries/desktop/filters/mercenaries-mode-filter-dropdown.component';
import {
    MercenariesPveDifficultyFilterDropdownComponent
} from '../../components/mercenaries/desktop/filters/mercenaries-pve-difficulty-filter-dropdown.component';
import {
    MercenariesPvpMmrFilterDropdownComponent
} from '../../components/mercenaries/desktop/filters/mercenaries-pvp-mmr-filter-dropdown.component';
import {
    MercenariesRoleFilterDropdownComponent
} from '../../components/mercenaries/desktop/filters/mercenaries-role-filter-dropdown.component';
import {
    MercenariesStarterFilterDropdownComponent
} from '../../components/mercenaries/desktop/filters/mercenaries-starter-filter-dropdown.component';
...
} from '../../components/mercenaries/desktop/mercenaries-meta-hero-details.component';
import {
    MercenariesMetaHeroStatComponent
} from '../../components/mercenaries/desktop/mercenaries-meta-hero-stat.component';
import {
    MercenariesMetaHeroStatsComponent
} from '../../components/mercenaries/desktop/mercenaries-meta-hero-stats.component';
...
} from '../../components/mercenaries/desktop/mercenaries-personal-hero-stat.component';
import {
...
} from '../../components/mercenaries/desktop/mercenaries-personal-team-summary.component';
import {
    MercenariesHeroSearchComponent
} from '../../components/mercenaries/desktop/secondary/mercenaries-hero-search.component';
import {
    MercenariesHeroDetailsComponent
} from '../../components/mercenaries/desktop/toberebuilt_mercenaries-hero-details.component';
import {
    MercenariesComposiionDetailsComponent
} from '../../components/mercenaries/desktop/unused_mercenaries-composition-details.component';
import {
    MercenariesCompositionStatComponent
} from '../../components/mercenaries/desktop/unused_mercenaries-composition-stat.component';
import {
    MercenariesCompositionsStatsComponent
} from '../../components/mercenaries/desktop/unused_mercenaries-compositions-stats.component';
import {
    MercenariesActionsQueueComponent
} from '../../components/mercenaries/overlay/action-queue/mercenaries-action-queue..component';
import {
    MercenariesActionComponent
} from '../../components/mercenaries/overlay/action-queue/mercenaries-action.component';
import {
    MercenariesHighlightDirective
} from '../../components/mercenaries/overlay/teams/mercenaries-highlight.directive';
import {
    MercenariesOpponentTeamComponent
} from '../../components/mercenaries/overlay/teams/mercenaries-opponent-team.component';
import {
    MercenariesOutOfCombatPlayerTeamComponent
} from '../../components/mercenaries/overlay/teams/mercenaries-out-of-combat-player-team.component';
import {
    MercenariesPlayerTeamComponent
} from '../../components/mercenaries/overlay/teams/mercenaries-player-team.component';
import {
    MercenariesTeamAbilityComponent
} from '../../components/mercenaries/overlay/teams/mercenaries-team-ability.component';
import {
    MercenariesTeamControlBarComponent
} from '../../components/mercenaries/overlay/teams/mercenaries-team-control-bar.component';
...
} from '../../components/mercenaries/overlay/teams/mercenaries-team-mercenary.component';
import {
...
} from '../../components/mercenaries/overlay/treasure-selection/mercenaries-out-of-combat-treasure-selection.component';
import {NotificationsComponent} from '../../components/notifications.component';
import {
    BgsBannedTribesWidgetWrapperComponent
} from '../../components/overlays/bgs-banned-tribes-widget-wrapper.component';
import {
    BgsBattleSimulationWidgetWrapperComponent
} from '../../components/overlays/bgs-battle-simulation-widget-wrapper.component';
...
} from '../../components/overlays/bgs-hero-selection-widget-wrapper.component';
...
} from '../../components/overlays/bgs-minion-tiers-widget-wrapper.component';
import {
    BgsWindowButtonWidgetWrapperComponent
} from '../../components/overlays/bgs-window-button-widget-wrapper.component';
...
} from '../../components/overlays/constructed-board-widget-wrapper.component';
import {
    AbstractCounterWidgetWrapperComponent
} from '../../components/overlays/counters/abstract-counter-widget-wrapper.component';
import {
    OpponentCounterWidgetWrapperComponent
} from '../../components/overlays/counters/opponent-attack-widget-wrapper.component';
import {
    OpponentCthunWidgetWrapperComponent
} from '../../components/overlays/counters/opponent-cthun-widget-wrapper.component';
import {
    OpponentElwynnBoarWidgetWrapperComponent
} from '../../components/overlays/counters/opponent-elwynn-boar-widget-wrapper.component';
import {
    OpponentFatigueWidgetWrapperComponent
} from '../../components/overlays/counters/opponent-fatigue-widget-wrapper.component';
import {
    OpponentGalakrondWidgetWrapperComponent
} from '../../components/overlays/counters/opponent-galakrond-widget-wrapper.component';
import {
    OpponentHeroPowerDamageWidgetWrapperComponent
} from '../../components/overlays/counters/opponent-hero-power-damage-widget-wrapper.component';
import {
    OpponentJadeWidgetWrapperComponent
} from '../../components/overlays/counters/opponent-jade-widget-wrapper.component';
import {
    OpponentLibramWidgetWrapperComponent
} from '../../components/overlays/counters/opponent-libram-widget-wrapper.component';
import {
    OpponentPogoWidgetWrapperComponent
} from '../../components/overlays/counters/opponent-pogo-widget-wrapper.component';
import {
    OpponentWatchpostCounterWidgetWrapperComponent
} from '../../components/overlays/counters/opponent-watchpost-widget-wrapper.component';
import {
    PlayerCounterWidgetWrapperComponent
} from '../../components/overlays/counters/player-attack-widget-wrapper.component';
import {
    PlayerBolnerWidgetWrapperComponent
} from '../../components/overlays/counters/player-bolner-widget-wrapper.component';
import {
    PlayerBrilliantMacawWidgetWrapperComponent
} from '../../components/overlays/counters/player-brilliant-macaw-widget-wrapper.component';
import {
    PlayerCthunWidgetWrapperComponent
} from '../../components/overlays/counters/player-cthun-widget-wrapper.component';
import {
    PlayerElementalWidgetWrapperComponent
} from '../../components/overlays/counters/player-elemental-widget-wrapper.component';
import {
    PlayerElwynnBoarWidgetWrapperComponent
} from '../../components/overlays/counters/player-elwynn-boar-widget-wrapper.component';
import {
    PlayerFatigueWidgetWrapperComponent
} from '../../components/overlays/counters/player-fatigue-widget-wrapper.component';
import {
    PlayerGalakrondWidgetWrapperComponent
} from '../../components/overlays/counters/player-galakrond-widget-wrapper.component';
import {
    PlayerHeroPowerDamageWidgetWrapperComponent
} from '../../components/overlays/counters/player-hero-power-damage-widget-wrapper.component';
import {
    PlayerJadeWidgetWrapperComponent
} from '../../components/overlays/counters/player-jade-widget-wrapper.component';
import {
    PlayerLibramWidgetWrapperComponent
} from '../../components/overlays/counters/player-libram-widget-wrapper.component';
import {
    PlayerMulticasterWidgetWrapperComponent
} from '../../components/overlays/counters/player-multicaster-widget-wrapper.component';
import {
    PlayerPogoWidgetWrapperComponent
} from '../../components/overlays/counters/player-pogo-widget-wrapper.component';
import {
    PlayerSpellWidgetWrapperComponent
} from '../../components/overlays/counters/player-spell-widget-wrapper.component';
import {
    PlayerWatchpostCounterWidgetWrapperComponent
} from '../../components/overlays/counters/player-watchpost-widget-wrapper.component';
import {
    DecktrackerOpponentWidgetWrapperComponent
} from '../../components/overlays/decktracker-opponent-widget-wrapper.component';
import {
    DecktrackerPlayerWidgetWrapperComponent
} from '../../components/overlays/decktracker-player-widget-wrapper.component';
import {
    DuelsMaxLifeOpponentWidgetWrapperComponent
} from '../../components/overlays/duels-max-life-player-widget-wrapper.component';
...
} from '../../components/overlays/mercs-action-queue-widget-wrapper.component';
import {
    MercsOpponentTeamWidgetWrapperComponent
} from '../../components/overlays/mercs-opponent-team-widget-wrapper.component';
import {
    MercsOutOfCombatPlayerTeamWidgetWrapperComponent
} from '../../components/overlays/mercs-out-of-combat-player-team-widget-wrapper.component';
import {
    MercsPlayerTeamWidgetWrapperComponent
} from '../../components/overlays/mercs-player-team-widget-wrapper.component';
import {
    MercsTreasureSelectionWidgetWrapperComponent
} from '../../components/overlays/mercs-treasure-selection-widget-wrapper.component';
...
} from '../../components/overlays/opponenthand/opponent-card-turn-number.component';
...
} from '../../components/overlays/_full-screen-overlays-clickthrough.component';
...
} from '../../components/replays/filters/replays-bg-hero-filter-dropdown.component';
import {
    ReplaysDeckstringFilterDropdownComponent
} from '../../components/replays/filters/replays-deckstring-filter-dropdown.component';
import {
    ReplaysGameModeFilterDropdownComponent
} from '../../components/replays/filters/replays-game-mode-filter-dropdown.component';
import {
    ReplaysOpponentClassFilterDropdownComponent
} from '../../components/replays/filters/replays-opponent-class-filter-dropdown.component';
import {
    ReplaysPlayerClassFilterDropdownComponent
} from '../../components/replays/filters/replays-player-class-filter-dropdown.component';
...
} from '../../components/settings/achievements/settings-achievements-menu.component';
import {
    SettingsAchievementsNotificationsComponent
} from '../../components/settings/achievements/settings-achievements-notifications.component';
...
} from '../../components/settings/achievements/unused_settings-achievements-live.component';
import {AdvancedSettingDirective} from '../../components/settings/advanced-setting.directive';
import {
    SettingsBattlegroundsGeneralComponent
} from '../../components/settings/battlegrounds/settings-battlegrounds-general.component';
import {
    SettingsBattlegroundsMenuComponent
} from '../../components/settings/battlegrounds/settings-battlegrounds-menu.component';
...
} from '../../components/settings/collection/settings-collection-notification';
...
} from '../../components/settings/decktracker/settings-decktracker-beta.component';
...
} from '../../components/settings/decktracker/settings-decktracker-menu.component';
import {
    SettingsDecktrackerOpponentDeckComponent
} from '../../components/settings/decktracker/settings-decktracker-opponent-deck';
import {
    SettingsDecktrackerYourDeckComponent
} from '../../components/settings/decktracker/settings-decktracker-your-deck';
...
} from '../../components/settings/general/settings-general-bug-report.component';
...
} from '../../components/settings/general/settings-general-localization.component';
...
} from '../../components/settings/general/settings-general-third-party.component';
import {SettingsGeneralComponent} from '../../components/settings/general/settings-general.component';
import {
    SettingsMercenariesGeneralComponent
} from '../../components/settings/mercenaries/settings-mercenaries-general.component';
import {
    SettingsMercenariesMenuComponent
} from '../../components/settings/mercenaries/settings-mercenaries-menu.component';
...
} from '../../components/settings/modal/modal-video-settings-changed.component';
...
} from '../../components/stats/desktop/filters/stats-xp-season-filter-dropdown.component';
...
} from '../../services/mercenaries/out-of-combat/mercenaries-out-of-combat.service';
